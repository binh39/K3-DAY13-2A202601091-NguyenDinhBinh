...
| Nguyễn Đình Bình (2A202601091) | CP2 SRE & Alerts: đặt SLO cho latency, error, cost, quality; viết 3 alert rules symptom-based và runbook điều tra/mitigation theo Metrics → Traces → Logs | Chưa commit/PR riêng | Cách đặt SLO từ dashboard contract, thiết kế alert theo ảnh hưởng người dùng và biến alert thành quy trình điều tra có evidence |
